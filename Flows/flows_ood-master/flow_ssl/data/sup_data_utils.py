...
from flow_ssl.data.transfer_datasets import TransferCIFAR,TransferSVHN, TransferCelebA, TransferTinyImageNet, TransferImageNetO
...
#         ds = getattr(torchvision.datasets, dataset.upper())
        ...
        elif dataset == "transferimageneto":
            ds = TransferImageNetO
            download = False

        else:
            ds = getattr(torchvision.datasets, dataset.upper())
    
    if dataset == 'transferimageneto':

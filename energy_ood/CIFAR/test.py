...
model_name = '/scratch/as14770/CV-FinalProject/energy_ood/CIFAR/snapshots/OE5kEpochsCifar100TinyImgNetOODoe_tune/TinyImageNet_wrn_s1_oe_tune_epoch_2168.pt'
if os.path.isfile(model_name):

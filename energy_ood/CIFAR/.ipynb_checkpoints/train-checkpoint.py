...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/OE5kEpochsCifar100TinyImgNetOOD', help='Folder to save checkpoints.')
...
ood_data = dset.ImageFolder('/scratch/as14770/CV-FinalProject/DATA/imagenet-o-train-test/train', transform=transform_ood)
...
if model_found:
    model_name = os.path.join('/scratch/as14770/CV-FinalProject/energy_ood/CIFAR/snapshots/pretrained/cifar100_wrn_pretrained_epoch_99.pt')
